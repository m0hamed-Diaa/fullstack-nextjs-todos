...
export default function Page() {
    return (
        <div className="min-h-212.5 sm:min-h-screen bg-linear-to-br from-slate-900 to-blue-900 flex items-center justify-center flex-col relative">
            {" "}
            <h2 className="text-xl md:text-3xl my-2 font-bold text-center">Sign up to access</h2>
            <SignUp
                appearance={{
                    elements: {
                        formButtonPrimary:
